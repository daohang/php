...
function updateonlylink($link,$mtitle)
{
	$sql="update onlylink set mtitle='$mtitle' where link='$link'";
	//echo $sql."</br>\n";
	$sqlresult=dh_mysql_query($sql);
	echo "mtitle=$mtitle|link=$link -> 更新onlylink成功！</br> \n";
}
